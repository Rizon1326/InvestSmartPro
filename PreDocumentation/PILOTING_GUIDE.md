...
| **Database** | PostgreSQL, Vector databases (Pinecone/Chroma/Weaviate) |
...
pip install django djangorestframework langchain psycopg2-binary
...
CREATE USER investsmart_user WITH PASSWORD 'your_password';
GRANT ALL PRIVILEGES ON DATABASE investsmart TO investsmart_user;
```

### Environment Variables
```bash
# .env file
DATABASE_URL=postgresql://investsmart_user:your_password@localhost:5432/investsmart
